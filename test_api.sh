...
ADMIN_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIxIiwiZW1haWwiOiJhZG1pbkBuZmNhcGkuY29tIiwicm9sZSI6IkFETUlOIiwiaWF0IjoxNzczODU4NTY2LCJleHAiOjE3NzM5NDQ5NjZ9.dC6GfCqKi2hXQOl2Yv-QUrHreZ2nxgrMqKYmFIzA6Z4"

# Alice token (user_id=2, role=CUSTOMER, merchant_id=1 PENDING)
ALICE_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIyIiwiZW1haWwiOiJhbGljZUBleGFtcGxlLmNvbSIsInJvbGUiOiJDVVNUT01FUiIsImlhdCI6MTc3Mzg1ODU2NiwiZXhwIjoxNzczOTQ0OTY2fQ.eU490_gzXy7A3PiPpk3i05gbVNWAMX1C_bDPU4sIZoc"

# Merchant token (user_id=3, role=MERCHANT, merchant_id=2 ACTIVE+VERIFIED)
MERCHANT_TOKEN="eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJzdWIiOiIzIiwiZW1haWwiOiJtZXJjaGFudEB0ZXN0c2hvcC5jb20iLCJyb2xlIjoiTUVSQ0hBTlQiLCJpYXQiOjE3NzM4NTg1NjcsImV4cCI6MTc3Mzk0NDk2N30.YnaBXfAeq6lA_lnGdu25CocOg8wFOt4uRWRQZ3Jd5Qg"
